...
if __name__ == '__main__':
    ...
    client_start_cmd = f'{curr_dir}/bin/MPDtest_v1.2 {curr_dir}/config/downnode_mn.json' 
    client_std_f = open(f'client_stdout', mode='w')
    client_start_cmd_args = shlex.split(client_start_cmd)
    client_node = net.getNodeByName(topo.client_node)
    ...
    results = os.popen('python ../tools/get_score.py ./MPDTrace_00010203040506070809101112131415161718ff.txt').read().split('\n')
    print(results[-3:])
